...
const Header = () => {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-white border-b border-gray-100">
        ...
        {isOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-4">
              ...
              />
              <Link to="/questions" className="text-gray-600 hover:text-gray-900 py-2">Questions</Link>
              <Link to="/tags" className="text-gray-600 hover:text-gray-900 py-2">Tags</Link>
              ...
              {userInfo ? (
                ...
                <>
                  <Link to="/login" className="text-gray-600 hover:text-gray-900 py-2">Sign in</Link>
                  <Link to="/register" className="text-gray-600 hover:text-gray-900 py-2">Sign up</Link>
                </>
              )}
            </div>
          </div>
      ...
      {/* Notification Panel */}
      {showNotifications && (
        <div className="absolute right-4 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-100 max-h-96 overflow-y-auto">
          <div className="p-4">
            ...
            {notificationCount === 0 ? (
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-800">Your question received a new answer</p>
