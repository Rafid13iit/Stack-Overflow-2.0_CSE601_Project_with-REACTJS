                ...
                <div className="bg-white rounded-2xl shadow-lg px-8 py-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-2 text-gray-600">Share your question with the community</p>
                        </div>
                        ...
                        <form onSubmit={submitHandler} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        <Code className={`h-6 w-6 ${uploadOption === 'codeSnippet' ? 'text-indigo-500' : 'text-gray-400'}`} />
                                        <span className={`text-sm font-medium ${uploadOption === 'codeSnippet' ? 'text-indigo-700' : 'text-gray-600'}`}>
                                            Code Snippet
                                        </span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        <FileText className={`h-6 w-6 ${uploadOption === 'file' ? 'text-indigo-500' : 'text-gray-400'}`} />
                                        <span className={`text-sm font-medium ${uploadOption === 'file' ? 'text-indigo-700' : 'text-gray-600'}`}>
                                            Upload File
                                        </span>
                                    </button>
                                </div>
