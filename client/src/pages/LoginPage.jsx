...
import { useLoginMutation } from "../actions/usersApiSlice";
...
const LoginScreen = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      setFormError(err?.data?.message || "An error occurred during login");
    }
  };
  ...
  return (
    <div className="pt-16 min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg animate-fade-in-up">
        ...
        {formError && (
          <div
            className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg animate-shake"
            role="alert"
          >
